...
#pipeline_optimizer = TPOTClassifier(generations=5, population_size=20, cv=2,max_eval_time_mins=30,
#                                    random_state=42, verbosity=200, config_dict=tpot_config,n_jobs = 10)
...
#pipeline_optimizer.export('tpot_exported_pipeline_for_code.py')
